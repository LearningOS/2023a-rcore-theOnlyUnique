...
#line 3 "/workspaces/2023a-rcore-theOnlyUnique/qemu-7.0.0/hw/remote/trace-events"
...
static inline void _nocheck__trace_mpqemu_recv_io_error(int cmd, int size, int nfds)
{
    if (trace_event_get_state(TRACE_MPQEMU_RECV_IO_ERROR) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 4 "/workspaces/2023a-rcore-theOnlyUnique/qemu-7.0.0/hw/remote/trace-events"
